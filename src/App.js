...
function App() {
  ...
  const loadBlockchainData = async() =>{
    ...
    console.log("config[network.chainId].realEstate.address ", config[network.chainId].realEstate.address)
    ...
    <div> 
      ...
      <div className='cards__section'>
        ...
        {homes.map((home,index)=>(
          ...
          {toggle  && (
            <Home home={home} provider={provider} escrow={escrow} account={account} toggleProp={toggleProp} />
          )}
    </div>
  );
}
